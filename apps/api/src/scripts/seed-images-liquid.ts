/**
 * seed-images-liquid.ts
 * ─────────────────────────────────────────────────────────────────────────────
 * Bulk-uploads liquid recipe hero images from content/liquid-images/
 ...
 *
 * Run:
 *   npm run seed:images:liquid
 *
 * Flags (set as env vars before running):
 *   SKIP_SLUGS=l-01        Comma-separated slugs to skip (already uploaded).
 ...
 *
 * Notes:
 *   Files must be named l-01.jpg, l-02.png, … (case-insensitive).
 *   Files with non-matching names are skipped automatically.
 */
